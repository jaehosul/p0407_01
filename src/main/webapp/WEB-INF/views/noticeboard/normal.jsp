					...
					<div class=""
						...
						<div class="imgs" data-u="slides"
							...
							<div class="sub_link_menu_wrap"
								...
								<img class="bg_img" data-u="image" src="../images/story.jpg" border="0"
			...
			<div class="sub_link_box">
				<div class="sub_link_menu">
					<span id="sub_Color_f" class="sub_under_bar"><a
						href="/noticeboard/notice_list">공지사항</a></span> <span id="sub_Color_f"><a
						href="/noticeboard/board_list">문의게시판</a></span> <span id="sub_Color_f"><a
						href="/noticeboard/after_list">웨딩후기</a></span>
				</div>
			</div>
			<div id="contain02">
